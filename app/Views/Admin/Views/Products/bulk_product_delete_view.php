                        ...
                        <div class='mb-2 col-12 bg-light p-3 border-rounded rounded'>
                            ...
                            <div class='mb-2 col-12'>
                                ...
                                <div class='row p-0 m-0 justify-content-end'>
                                    <a class='text-sm' href='<?= base_url('assets/files/bulk_product_delete.xlsx'); ?>' download>Download Example File</a>
                                </div>
                            </div>
                    ...
                    <div class='col-6'>
                        <div class='mb-2 col-12 bg-light p-3 border-rounded rounded'>
                            ...
                            <div class='mb-2 col-12'>
                                ...
                                <input name='file' class='form-control' type='file'>
                                <div class='row p-0 m-0 justify-content-end'>
                                    <a class='text-sm' href='<?= base_url('assets/files/bulk_product_varient_delete.xlsx'); ?>' download>Download Example File</a>
                                </div>
                            </div>
                            <div class="col-12 d-flex justify-content-center">
                                <button class='btn btn-primary'> Save Product</button>
