...
<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Bulk Product Delete</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                        <li class="breadcrumb-item active">Bulk Product Delete</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <section class="content">
        ...
        <div class='p-5 m-3 card'>
            <div class='row'>
                <div class='col-6'>
                    <form class='bulk_product_delete'>
                        <div class='mb-2 col-12 bg-light p-3 border-rounded rounded'>
                            <p><b>Bulk Product Delete</b></p>
                            <div class='mb-2 col-12'>
                                <span class='form-label'> Upload File </span>
                                <input name='file' class='form-control' type='file'>
                                <div class='row p-0 m-0 justify-content-end'>
                                    <a class='text-sm' href='<?= base_url('assets/files/bulk_product_delete.csv'); ?>' download>Download Example File</a>
                                </div>
                            </div>
                ...
                <div class='col-6'>
                    <form class='bulk_product_varient_delete'>
                        <div class='mb-2 col-12 bg-light p-3 border-rounded rounded'>
                            <p><b>Bulk Product Varient Delete</b></p>
                            <div class='mb-2 col-12'>
                                <span class='form-label'> Upload File </span>
                                <input name='file' class='form-control' type='file'>
                                <div class='row p-0 m-0 justify-content-end'>
                                    <a class='text-sm' href='<?= base_url('assets/files/bulk_product_varient_delete.csv'); ?>' download>Download Example File</a>
                                </div>
                            </div>
                            <div class="col-12 d-flex justify-content-center">
                                <button class='btn btn-primary'> Save Product</button>
...
<script>
    $(document).ready(function() {
        $('.bulk_product_delete').submit(function(e) {
            e.preventDefault();
            $.ajax({
                type: "POST",
                url: "<?= base_url('bulk_product_delete') ?>",
        ...
        $('.bulk_product_varient_delete').submit(function(e) {
            e.preventDefault();
            $.ajax({
                type: "POST",
