...
<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Deleted Reviews </h1>
                </div>
                <div class="col-sm-6">
                            ...
                            <td width='150px'>
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu p-2" aria-labelledby="dropdownMenuButton">
                                        <a href='<?= base_url('Admin/undelete-accept-review/' . $row->id); ?>' class=''><button type='button' class='btn btn-sm btn-info w-100 mb-2'>Restore & Accept</button></a>
                                        <a href='<?= base_url('Admin/undelete-decline-review/' . $row->id); ?>' class=''><button type='button' class='btn btn-sm btn-info w-100 mb-2'>Restore & Decline</button></a>
                                    </div>
                                </div>
                            </td>
                        </tr>
...
<script>
    $(document).ready(function() {
        $('.search-btn').click(function() {
            window.location.href = '<?= base_url('Admin/deleted-list/?search='); ?>' + $('.search-input').val();
        });
    });
</script>
<?= $this->endSection() ?>